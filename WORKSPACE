...
load("@io_bazel_rules_scala//scala:scala.bzl", "rules_scala_setup", "rules_scala_toolchain_deps_repositories", "setup_scala_testing_toolchain")
...
maven_install(
    ...
    repositories = [
        "https://us-east-1.artifactory.musta.ch/artifactory/maven",
        "https://repo1.maven.org/maven2",
    ],
)

#register_toolchains("@io_bazel_rules_scala//testing:junit_toolchain")
